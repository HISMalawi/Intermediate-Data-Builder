...
ActiveRecord::Schema.define(version: 2019_06_12_133825) do
  ...
  create_table "locations", primary_key: "location_id", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "side_effects_has_medication_prescriptions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "side_effects_side_effect_id", null: false
    t.integer "medication_prescriptions_prescription_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "site_types", primary_key: "site_type_id", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "description"
    t.string "site_type"
    t.boolean "voided", default: false, null: false
    t.integer "voided_by"
  ...
  create_table "sites", primary_key: "site_id", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "site_name"
    t.string "short_name"
